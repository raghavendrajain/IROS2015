...
using namespace std;
ofstream myfile ("example_13.csv", ios::out | ios::app );
...
void MyController::onInit(InitEvent &evt) {  
  ...
  SimObj *target = getObj("box_003");
  SimObj *toolName = getObj("TShapeTool_003");
...
double MyController::onAction(ActionEvent &evt) {  
  ...
  {
           myfile << actionNumber  << " , " << functionalFeature << " , " << targetType  << " , " ;
