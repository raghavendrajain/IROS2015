...
using namespace std;
ofstream myfile ("cubeToolAfford.csv", ios::out | ios::app );
...
void MyController::onInit(InitEvent &evt) {  
  ...
  SimObj *toolName  = getObj("TShapeTool_11");
  SimObj *target = getObj("box_11");
...
double MyController::onAction(ActionEvent &evt) {  
  ...
  {
           myfile << actionNumber  << " , " << targetType << " , " <<  functionalFeature << " , " ;
           ...
           myfile << "\n"; 
           cout << "The simulation for " << actionNumber << " , " << targetType << " , " <<  functionalFeature << " has been recorded" << endl;
           cout <<  initTargetRotation.qw() <<  " , " << initTargetRotation.qx() <<  " , " << initTargetRotation.qy() <<  " , " << initTargetRotation.qz() << " , " << endl;
           // exit(0);
           flag = false;  
  }
